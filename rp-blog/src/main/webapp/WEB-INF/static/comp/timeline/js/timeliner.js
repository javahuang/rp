...
;(function($) {
        ...
        function startTimeliner(options) {
            var settings = {
                ...
                expandAllText: options ['expandAllText'] || '+ 展开',
                // sets the text of the expandAll selector after the timeline is fully collapsed
                // value: string
                // default: + expand all

                collapseAllText: options['collapseAllText'] || '- 折叠'
            ...
            if ($(settings.timelineContainer).data('started')) {
                ...
                $(settings.timelineContainer+" "+".timeline-toggle").html(settings.collapseAllText);
