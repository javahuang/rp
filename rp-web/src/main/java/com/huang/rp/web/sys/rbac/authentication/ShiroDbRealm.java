...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		List<SysUserRole> susUserRoleList = sysUserRoleMapper
	...
	protected AuthorizationInfo doGetAuthorizationInfo(
		...
		for (Map role : roleStrList) {
			info.addRole(String.valueOf(role.get("role")));
		}
		for (Map permission : permissionStrList) {
			info.addStringPermission(String.valueOf(permission
					.get("permission")));
		}
